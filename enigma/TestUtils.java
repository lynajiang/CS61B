...
class TestUtils {
    ...
    static final ArrayList<Rotor> ROTORS = new ArrayList<>();

    static {
        ROTORS.add(new Reflector("B", new Permutation("(AE) (BN) (CK) (DQ) (FU)"
                + " (GY) (HW) (IJ) (LO) (MP) (RX) (SZ) (TV)", UPPER)));
        ROTORS.add(new FixedRotor("BETA", new Permutation(
                "(ALBEVFCYODJWUGNMQTZSKPR) (HIX)", UPPER)));
        ROTORS.add(new MovingRotor("I", new Permutation("(AELTPHQXRU) (BKNW)"
                + " (CMOY) (DFG) (IV) (JZ) (S)", UPPER), "Q"));
        ROTORS.add(new MovingRotor("II", new Permutation("(FIXVYOMW) (CDKLHUP)"
                + " (ESZ) (BJ) (GR) (NT) (A) (Q)", UPPER), "E"));
        ROTORS.add(new MovingRotor("III", new Permutation("(ABDHPEJT) "
                + "(CFLVMZOYQIRWUKXSG)"
                + " (N)", UPPER), "V"));
        ROTORS.add(new MovingRotor("IV", new Permutation(
                "(AEPLIYWCOXMRFZBSTGJQNH) (DV) (KU)", UPPER), "J"));
        ROTORS.add(new MovingRotor("V", new Permutation("(AVOLDRWFIUQ) "
                + "(BZKSMNHYC) (EGTJPX)", UPPER), "Z"));
